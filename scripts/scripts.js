...
var requestURL = "DATA_JSON/Season_2024/Arsenal_FC_11_2024.json";
...
/*const listaTeam = ["Arsenal FC", "Aston Villa", "AFC Bournemouth", "Brendtford FC", "Brighton and Hove Albion", "Chlsea FC", "Crystal Palace", "Everton FC", "Fulham FC", "Ipswich Town", 
                   ...
                   "Wimbledon FC (- 2004)"];*/
const listaTeam = ["Arsenal_FC", "Aston_Villa", "AFC_Bournemouth", "Brendtford_FC", "Brighton_and_Hove_Albion", "Chlsea_FC", "Crystal_Palace", "Everton_FC", "Fulham_FC", "Ipswich_Town",
  "Leicester_City", "Liverpool_FC", "Manchester_City", "Manchester_United", "Newcastle_United", "Nottingham_Forest", "Southhampton_FC", "Tottenam_Hotspur", "West_Ham_United", "Wolverhampton_Wanderers",
  "Burnley_FC", "Luton_Town", "Sheffield_United", "Barnsley_FC", "Birmingham_City", "Blackburn_Rovers", "Blackpool_FC", "Bolton_Wanderers", "Bradford_City", "Cardiff_City",
  "Charlton_Athletic", "Coventy_City", "Derby_County", "Huddersfield_Town", "Hull_City", "Leeds_United", "Middlesbrough_FC", "Norwich_City", "Oldham_Athletic", "Portsmouth_FC",
  "Queens_Park_Rangers", "Reading_FC", "Sheffield_Wednesday", "Stoke_City", "Sunderland_AFC", "Swansea_City", "Swindon_Town", "Watford_FC", "West_Bromwich_Albion", "Wigam_Athletic",
  "Wimbledon_FC_(-_2004)"];
...
function setUrl() {
  ...
  var stagione = selStagione.value; 
  var teamValue = selTeam.value; 
  var teamText = selTeam.options[selTeam.selectedIndex].textContent; 
  requestURL = "DATA_JSON/" + "Season" + stagione + "/" + teamText + "_" + teamValue + "_" + stagione + ".json"
}
